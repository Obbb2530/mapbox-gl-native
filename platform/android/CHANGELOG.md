...
- Calculate GeoJSON tile geometries in a background thread, so that the rendering thread is not blocked. [#15953](https://github.com/mapbox/mapbox-gl-native/pull/15953)
